...
namespace Assignment3
{
    public interface ILinkedListADT
    {
        ...
        /// <summary>
        /// Reverse the order of all the elements in the list.
        /// </summary>
        void Invert();

        /// <summary>
        /// Sorts the order of all the elements in the list in ascending order of users name's.
        /// </summary>
        void Sort();

        /// <summary>
        /// Copys all the elements in the list to an array.
        /// </summary>
        User[] ToArray();
        ...
        /// </summary>
        void Join(SLL list1, SLL list2);

        /// <summary>
        /// Seperates a lists into two at an index.
        /// </summary>
        (SLL, SLL) Seperate(int index);
    }
}
